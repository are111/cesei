...
### 2. 获取/更新脚本
```bash
wget -O Xray-TLS+Web-setup.sh https://github.com/are111/cesei/raw/main/Xray-TLS+Web-setup.sh
```
### 3. 执行脚本
```bash
...
## 运行截图
<div>
    <img width="400" src="https://github.com/are111/cesei/blob/main/image/menu.jpg">
</div>
<div>
    <img width="600" src="https://github.com/are111/cesei/blob/main/image/protocol.jpg">
</div>
